...
// InteriorDesignPhotos array lai import gareko
import { InteriorDesignPhotos } from '../Comp/Data'; 
...
const Interior = () => {
  ...
  const currentItems = InteriorDesignPhotos.slice(indexOfFirstItem, indexOfLastItem);
  const totalPages = Math.ceil(InteriorDesignPhotos.length / itemsPerPage);
    ...
    <section className="py-5 bg-white mt-5">
      <div className="container py-4">
        <div className="text-center mb-5">
          <h2 className="fw-bold" style={{ color: '#001A7E' }}>Interior <span style={{ color: '#f39c12' }}>Design Gallery</span></h2>
          <div className="mx-auto mt-2" style={{ width: '50px', height: '3px', background: '#f39c12' }}></div>
        </div>

        {/* --- Image Grid Mapping InteriorDesignPhotos --- */}
        ...
        {selectedImg && (
          ...
          >
            ...
            >
              ...
              <img src={selectedImg} className="img-fluid rounded-3 w-100" alt="Interior Preview" />
