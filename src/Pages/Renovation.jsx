...
// RenovationPhotos array lai import gareko
import { RenovationPhotos } from '../Comp/Data'; 
...
const Renovation = () => {
  ...
  const currentItems = RenovationPhotos.slice(indexOfFirstItem, indexOfLastItem);
  const totalPages = Math.ceil(RenovationPhotos.length / itemsPerPage);
    ...
    <section className="py-5 bg-white mt-5">
      <div className="container py-4">
        <div className="text-center mb-5">
          <h2 className="fw-bold" style={{ color: '#001A7E' }}>Renovation <span style={{ color: '#f39c12' }}>Gallery</span></h2>
          <div className="mx-auto mt-2" style={{ width: '50px', height: '3px', background: '#f39c12' }}></div>
        </div>

        {/* --- Image Grid Mapping RenovationPhotos --- */}
          ...
          {currentItems.map((item) => (
            <div key={item.id} className="col-lg-3 col-md-4 col-sm-6">
              ...
              >
                <img 
                  src={item.image} 
                  alt={`Renovation Project ${item.id}`} 
        ...
        {selectedImg && (
          ...
          >
            ...
            >
              ...
              <img src={selectedImg} className="img-fluid rounded-3 w-100" alt="Renovation Preview" />
